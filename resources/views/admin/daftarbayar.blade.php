<x-admin-layout>
    <div class="container px-6 py-8 mx-auto">
        <h3 class="text-3xl font-medium text-gray-700">Daftar Pembayaran</h3>
                ...
                <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                        <div class="p-3 bg-indigo-600 bg-opacity-75 rounded-full">
                            <svg class="w-8 h-8 text-white" viewBox="0 2 28 30" fill="none"
                        ...
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">{{ $jumlahPengguna }}</h4>
                ...
                <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                        <div class="p-3 bg-orange-600 bg-opacity-75 rounded-full">
                            <svg class="w-8 h-8 text-white" viewBox="-1 -1 30 28" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">{{ $jumlahToko }}</h4>
                ...
                <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                        <div class="p-3 bg-pink-600 bg-opacity-75 rounded-full">
                            <svg class="w-8 h-8 text-white" viewBox="0 1 28 28" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">{{ $jumlahBuku }}</h4>
                            ...
                            @foreach ($bayar as $pembayaran)
                                <tr>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <div class="text-sm leading-5 text-gray-900">{{ $pembayaran->pesanan->buku->judul }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <div class="text-sm leading-5 text-gray-900">{{ $pembayaran->metode_pembayaran }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <div class="text-sm leading-5 text-gray-900">
                                            <img src="{{ asset($pembayaran->image) }}" alt="Bukti Pembayaran" class="w-20 h-20 object-cover rounded-md">
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
