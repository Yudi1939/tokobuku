...
<body class="font-sans antialiased bg-gray-200">
    ...
    <nav class="flex items-center justify-between px-6 py-4 bg-white shadow-md">
        ...
        <div class="flex items-center space-x-6">
            <!-- Kategori Dropdown -->
            <select class="border border-gray-300 rounded p-2 w-40 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <form action="" method="get" class="flex items-center space-x-2">
                <input type="text" placeholder="Cari buku..." class="border border-gray-300 rounded p-2 w-48 focus:outline-none focus:ring-2 focus:ring-blue-500">
